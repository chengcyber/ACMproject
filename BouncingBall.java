...
public class BouncingBall extends GraphicsProgram {
	...
	/** Amount Y Velocity in reduced when it bounces */
	private static final double BOUNCE_REDUCE = 0.9;
	
	/** Strarting X and Y Velocities */
	...
	/** Determin if collision with floor. upadate velocities
	 *  and location as appropriate */
	private void checkForCollision() {
		// determine if ball has dropped below the floor
		if (ball.getY() > getHeight() - DIAM_BALL) {
			
			// change ball's Y velocity to new bonce upwards
			yVel = - yVel *BOUNCE_REDUCE;
			
			// assume bounce will move ball and an amount about the
